...
const wifi_driver_info_t driver_info = {
    ...
    "pi4",
    "cfg80211",
    { "RaspBerry",                       "RaspBerry",   "PI",        "PI",            "Model Description", "Model URL", "267",
      "WPS Access Point",                                                                                                                           "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "bpi4",
    "cfg80211",
    { "Banana Filogic Wireless Gateway", "Banana",      "PI",        "PI",            "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    platform_set_radio_pre_init,
    ...
    "tcxb7",
    "dhd",
    { "Xfinity Wireless Gateway",        "Technicolor", "XB7",       "CGM4331COM",    "Model Description",
      "Model URL",                                                                                                       "267", "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    platform_set_radio_pre_init,
    ...
    "vntxer5",
    "wifi_3_0",
    { "Xfinity Wireless Gateway",        "Vantiva",     "XER5",      "XER5",          "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "dt_gemini7_2",
    "wifi_3_0",
    { "Wireless Extender",               "DT",          "GEMINI7_2", "GR-EXT02A-CTS", "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "tcxb8",
    "dhd",
    { "Xfinity Wireless Gateway",        "Technicolor", "XB8",       "CGM4981COM",    "Model Description",
      "Model URL",                                                                                                       "267", "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "cbrv2",
    "dhd",
    { "Xfinity Wireless Gateway",        "Technicolor", "CBRV2",     "CGA4332COM",    "Model Description",
      "Model URL",                                                                                                       "267", "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    { "Xfinity Wireless Gateway",        "Technicolor", "XB10",      "CGM601TCOM",    "Model Description",
      "Model URL",                                                                                                       "267", "WPS Access Point", "Manufacturer URL" },
#endif
#ifdef WPS_SERCOMMXB10_INFO
    { "Xfinity Wireless Gateway",        "Sercomm",     "XB10",      "SG417DBCT",     "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
#endif
    platform_pre_init,
    platform_post_init,
    ...
    "xer10",
    "dhd",
    { "Xfinity Wireless Gateway",        "Sercomm",     "XER10",     "SCER11BEL",     "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "xf10",
    "dhd",
    { "Xfinity Wireless Gateway",        "Sercomm",     "XF10",      "SCXF11BFL",     "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "cmxb7",
    "mtlk",
    { "Xfinity Wireless Gateway",        "Commscope",   "XB7",       "TG4482PC2",     "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "xle",
    "cfg80211",
    { "Xfinity Wireless Gateway",        "SKY",         "XLE",       "WNXL11BWL",     "Model Description", "Model URL",
      "267",                                                                                                                    "WPS Access Point", "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "skysr213",
    "dhd",
    { "Sky Wireless Gateway",            "SKY",         "HUB6",      "SKYSR213",      "Model Description", "Model URL", "267",
      "WPS Access Point",                                                                                                                           "Manufacturer URL" },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
    ...
    "rdkb",
    "dhd",
    { "rdkb",                            "rdkb",        "cm",        "cm",            "Model Description", "Model URL", "267", "WPS Access Point",
      "Manufacturer URL"                                                                                                                                               },
    platform_pre_init,
    platform_post_init,
    platform_set_radio,
...
static const char *const eu_op_class_cc[] = { "AL", "AM", "AT", "AZ", "BA", "BE", "BG", "BY", "CH",
    "CY", "CZ", "DE", "DK", "EE", "EL", "ES", "FI", "FR", "GE", "HR", "HU", "IE", "IS", "IT", "LI",
        ...
        if (strcmp(interface_index_map[index].interface_name, interface_name) == 0) {
            ...
            if (radio == NULL) {
                ...
                wifi_hal_info_print("%s:%d:radio index:%d interface_name:%s band:%d\n", __func__,
                    __LINE__, interface_index_map[index].rdk_radio_index, interface_name,
...
BOOL is_wifi_hal_vap_hotspot_open(UINT ap_index)
{
    ...
    for (index = 0; index < get_sizeof_interfaces_index_map(); index++) {
        if ((interface_index_map[index].index == ap_index) &&
            (strncmp(interface_index_map[index].vap_name, "hotspot_open", strlen("hotspot_open")) ==
                0)) {
            return true;
        }
    }
...
BOOL is_wifi_hal_vap_mesh_backhaul(UINT ap_index)
{
    ...
    for (index = 0; index < get_sizeof_interfaces_index_map(); index++) {
        if ((interface_index_map[index].index == ap_index) &&
            (strncmp(interface_index_map[index].vap_name, "mesh_backhaul",
                 strlen("mesh_backhaul")) == 0)) {
            return true;
        }
    }
    return false;
...
BOOL is_wifi_hal_vap_hotspot_secure(UINT ap_index)
{
    ...
    for (index = 0; index < get_sizeof_interfaces_index_map(); index++) {
        if ((interface_index_map[index].index == ap_index) &&
            (strncmp(interface_index_map[index].vap_name, "hotspot_secure",
                 strlen("hotspot_secure")) == 0)) {
            return true;
        }
    }
    return false;
...
BOOL is_wifi_hal_vap_lnf_radius(UINT ap_index)
{
    ...
    for (index = 0; index < get_sizeof_interfaces_index_map(); index++) {
        if ((interface_index_map[index].index == ap_index) &&
            (strncmp(interface_index_map[index].vap_name, "lnf_radius", strlen("lnf_radius")) ==
                0)) {
            return true;
        }
    }
...
int get_interface_name_from_radio_index(uint8_t radio_index, char *interface_name)
{
    ...
    for (i = 0; i < get_sizeof_radio_interfaces_map(); i++) {
        if (l_radio_interface_map[i].radio_index == radio_index) {
            strncpy(interface_name, l_radio_interface_map[i].interface_name,
                strlen(l_radio_interface_map[i].interface_name));
            return RETURN_OK;
        }
    }
...
int set_interface_properties(unsigned int phy_index, wifi_interface_info_t *interface)
{
    ...
    for (i = 0; i < get_sizeof_interfaces_index_map(); i++) {
        map = &interface_index_map[i];
        if ((strcmp(interface->name, map->interface_name) == 0) && (phy_index == map->phy_index)) {
...
wifi_interface_info_t *get_interface_by_vap_index(unsigned int vap_index)
{
    ...
    // __LINE__, vap_index, g_wifi_hal.num_radios);
    for (i = 0; i < g_wifi_hal.num_radios; i++) {
...
BOOL get_ie_ext_by_eid(unsigned int eid, unsigned char *buff, unsigned int buff_len,
    unsigned char **ie_out, unsigned short *ie_out_len)
{
...
BOOL get_ie_by_eid(unsigned int eid, unsigned char *buff, unsigned int buff_len,
    unsigned char **ie_out, size_t *ie_out_len)
{
    ieee80211_tlv_t *ie = NULL;
    signed int len;
...
int get_radio_variant_str_from_int(unsigned int variant, char *variant_str)
{
    ...
    for (index = 0; index < ARRAY_SIZE(wifi_variant_Map); index++) {
        if ((variant & wifi_variant_Map[index].enum_val) && (strlen(temp_variant_str) == 0)) {
            snprintf(temp_variant_str, sizeof(temp_variant_str), "%s",
                wifi_variant_Map[index].str_val);
            ...
            strncat(temp_variant_str, wifi_variant_Map[index].str_val,
                sizeof(temp_variant_str) - strlen(temp_variant_str) - 1);
        }
    }
...
{
    int sec_mode = 0;
    if ((mode == wifi_security_mode_wpa_enterprise) ||
...
int get_security_mode_int_from_str(char *security_mode_str, char *mfp_str,
...
int get_security_mode_str_from_int(wifi_security_modes_t security_mode, unsigned int vap_index,
    char *security_mode_str)
{
    (void)vap_index;
...
int get_security_encryption_mode_str_from_int(wifi_encryption_method_t encryption_mode,
    unsigned int vap_index, char *encryption_mode_str)
{
    (void)vap_index;
...
#ifdef CONFIG_IEEE80211BE
    {
        ...
        if (interface->vap_info.vap_mode == wifi_vap_mode_ap) {
            const wifi_security_modes_t security_mode =
                interface->vap_info.u.bss_info.security.mode;
            switch (security_mode) {
            case wifi_security_mode_wpa3_personal:
            case wifi_security_mode_wpa3_transition:
            case wifi_security_mode_wpa3_enterprise:
...
INT get_coutry_str_from_oper_params(wifi_radio_operationParam_t *operParams, char *country)
{
    ...
    for (index = 0; index < ARRAY_SZ(wifi_country_map); index++) {
        if (wifi_country_map[index].countryCode == operParams->countryCode) {
            strncpy(tmp_countrycode_str, wifi_country_map[index].countryStr,
                sizeof(wifi_country_map[index].countryStr) - 1);
            break;
        }
    }
    ...
    for (index = 0; index < ARRAY_SZ(wifi_environment_map); index++) {
        if (wifi_environment_map[index].operatingEnvironment == operParams->operatingEnvironment) {
            strncpy(tmp_environment_str, wifi_environment_map[index].environment,
                sizeof(wifi_environment_map[index].environment) - 1);
            break;
        }
    }
...
wifi_interface_info_t *rnr_sta6(void)
{
    ...
    for (r = 0; r < g_wifi_hal.num_radios; r++) {
        ...
        return hash_map_get_first(g_wifi_hal.radio_info[r].interface_map);
    }
    return NULL;
}
                ...
                if (sscanf(trimmed, "Band %d:", &band_num) == 1) {
                    ...
                    if (curr_phy_idx < MAX_NUM_RADIOS &&
                        ...
                        wifi_hal_error_print("%s:%d: Recieved phy_index:%d Num Radios:%d \
                            ...
                            __func__, __LINE__, curr_phy_idx, MAX_NUM_RADIOS, band_num,
                            NUM_NL80211_BANDS);
                        return false;
                    }
                } else {
...
static void remap_phy_index(wifi_interface_name_idex_map_t *map, int map_size,
    const int *pcie_index, int pcie_size)
{
...
int get_wifi_op_class_info(wifi_countrycode_type_t country_code,
    wifi_country_radio_op_class_t *op_classes)
{
...
int get_sec_channel_offset(wifi_radio_info_t *radio, int freq)
{
    ...
    if ((freq >= MIN_FREQ_MHZ_2G) && (freq <= MAX_FREQ_MHZ_2G)) {
        ...
        wifi_hal_info_print("%s:%d: Unknown frequency: %d in attribute of phy index: %d\n",
            __func__, __LINE__, freq, radio->index);
        return 0;
    }

    for (i = 0; i < radio->hw_modes[band].num_channels; i++) {
        if (freq == radio->channel_data[band][i].freq) {
            /* sec_chan_offset for 20MHz will be 0. For bandwidth 40MHz, 80MHz sec_chan_offset will
             * be a non-zero value*/
...
int get_bw80_center_freq(wifi_radio_operationParam_t *param, const char *country)
{
    ...
    unsigned int center_channels_6g[] = { 7, 23, 39, 55, 71, 87, 103, 119, 135, 151, 167, 183, 199,
        215 };
...
void update_ecomode_radio_capabilities(wifi_radio_info_t *radio)
{
    ...
    unsigned int channels_5g[] = { 36, 40, 44, 48, 52, 56, 60, 64, 100, 104, 108, 112, 116, 132,
        136, 140, 144, 149, 153, 157, 161, 165 };
    unsigned int channels_6g[] = { 5, 21, 37, 53, 69, 85, 101, 117, 133, 149, 165, 181, 197, 213,
        229 };
    ...
    if (interface != NULL) {
        ...
        if (strstr(vap->vap_name, "2g") != NULL) {
            ...
            wifi_hal_error_print(
                "%s:%d: Failed in updating frequency band for the eco mode radio\n", __func__,
                __LINE__);
            return;
        }
    }
    ...
    for (radioIndex = 0; radioIndex < get_sizeof_radio_interfaces_map(); radioIndex++) {
        ...
        for (j = 0; j < g_wifi_hal.num_radios; j++) {
            ...
            if (radio->rdk_radio_index == l_radio_interface_map[radioIndex].radio_index) {
                // Radio interface not in ECO mode [Added already in g_wifi_hal.radio_info after
                // notification from driver]
                found = 1;
        ...
        if (!found) {
            ...
            snprintf(radio->name, sizeof(radio->name), "%s",
                l_radio_interface_map[radioIndex].radio_name);
            ...
            for (vapIndex = 0; vapIndex < get_sizeof_interfaces_index_map(); vapIndex++) {
                ...
                if (interface_index_map[vapIndex].rdk_radio_index !=
                    l_radio_interface_map[radioIndex].radio_index) {
                    continue;
                }
                ...
                snprintf(interface->name, sizeof(interface->name), "%s",
                    interface_index_map[vapIndex].interface_name);
                ...
                wifi_hal_dbg_print(
                    ...
                    interface->name, interface->type, interface->mac[0], interface->mac[1],
            ...
            // Build the sleeping radio capabilities manually based on the available info in the
            // 'radio' to bringup webconfig,  Device.WiFi.**
        ...
        if (interface_index_map[i].rdk_radio_index == rdk_radio_index) {
            ...
            if (suffix && strlen(suffix + 1) > 0) {
                ...
                if (strncmp(band_str, "2g", 2) == 0) {
                    return NL80211_BAND_2GHZ;
                } else if (strncmp(band_str, "5g", 2) == 0 || strncmp(band_str, "5gl", 3) == 0 ||
...
int wifi_strcpy(char *dest, size_t dest_size, const char *src)
{
    ...
    // Check for overlap
    if ((src >= dest && src < dest + dest_size) || (dest >= src && dest < src + srclen))
        return -1;
...
int wifi_strncpy(char *dest, size_t dest_size, const char *src, size_t count)
{
    ...
    // Check for overlap
    if ((src >= dest && src < dest + dest_size) || (dest >= src && dest < src + count))
        return -1;
...
int str_list_append(char *dest, size_t dest_size, const char *src)
{
    if (dest_size == 0)
        return 0;
    if (dest[0] == '\0') {
        if (wifi_strcpy(dest, dest_size, src))
            return -1;
    } else {
        if (wifi_strcat(dest, dest_size, ","))
            return -1;
        if (wifi_strcat(dest, dest_size, src))
            return -1;
    }
    return 0;
}

static int wifi_enum_bitmap_to_str(char *dest, size_t dest_size, const wifi_enum_to_str_map_t map[],
    size_t map_size, const char *prefix, int bitmap)
{
    size_t i;
...
{
    return wifi_enum_bitmap_to_str(dest, dest_size, wifi_bandwidth_Map,
        ARRAY_SIZE(wifi_bandwidth_Map), "", (int)bandwidth);
}

int wifi_bitrate_to_str(char *dest, size_t dest_size, wifi_bitrate_t bitrate)
{
    return wifi_enum_bitmap_to_str(dest, dest_size, wifi_bitrate_Map, ARRAY_SIZE(wifi_bitrate_Map),
        "", (int)bitrate);
}
            ...
            if (g_info->config.apIndex == vap_index) {
                *g_idx = g_ptr->group_index;
                wifi_hal_dbg_print("%s:%d: found group index %d for ap_index:%d\n", __func__,
                    __LINE__, g_ptr->group_index, vap_index);
...
int wifi_steering_del_mac_list(uint32_t vap_index, bm_sta_list_t *sta_info)
{
    ...
    if (sta_info->is_acl_set != true) {
        wifi_hal_error_print(
            "steering mac filter acl is not configured for sta:%s on vap_index:%d\n", key,
            vap_index);
        return RETURN_ERR;
    }
...
void re_configure_steering_mac_list(wifi_interface_info_t *interface)
{
    ...
    if (vap->vap_mode != wifi_vap_mode_ap) {
        ...
        wifi_hal_info_print("%s:%d: mac mode:%d for vap:%d\n", __func__, __LINE__,
            vap->u.bss_info.mac_filter_mode, vap->vap_index);
        return;
    }
...
{
    interface_index_map = (wifi_interface_name_idex_map_t *)malloc(
        sizeof(wifi_interface_name_idex_map_t) * MAX_NUM_SIMULATED_CLIENT);
    if (interface_index_map != NULL) {
        memset(interface_index_map, 0,
            sizeof(wifi_interface_name_idex_map_t) * MAX_NUM_SIMULATED_CLIENT);
    }

    l_radio_interface_map = (radio_interface_mapping_t *)malloc(
        sizeof(radio_interface_mapping_t) * MAX_NUM_SIMULATED_CLIENT);
    if (l_radio_interface_map != NULL) {
        memset(l_radio_interface_map, 0,
            sizeof(radio_interface_mapping_t) * MAX_NUM_SIMULATED_CLIENT);
    }
...
void update_interface_names(unsigned int phy_index, char *interface_name)
{
    ...
    for (; (tmp_interface_index_map != NULL);) {
        if ((tmp_interface_index_map->phy_index == phy_index)) {
            strncpy(tmp_interface_index_map->interface_name, interface_name,
                sizeof(wifi_interface_name_t));
            tmp_interface_index_map++;
            break;
        }
        tmp_interface_index_map++;
    ...
    for (; (tmp_radio_interface_map != NULL);) {
        if ((tmp_radio_interface_map->phy_index == phy_index)) {
            strncpy(tmp_radio_interface_map->interface_name, interface_name,
                sizeof(wifi_interface_name_t));
            tmp_radio_interface_map++;
            break;
        }
...
void update_interfaces_map(unsigned int phy_index, unsigned int interface_radio_index)
{
    ...
    for (; (tmp_interface_index_map != NULL);) {
        if (!strstr(tmp_interface_index_map->vap_name, "sim_sta")) {
            ...
            snprintf(tmp_interface_index_map->vap_name, sizeof(wifi_vap_name_t), "sim_sta_%d",
    ...
    for (; (tmp_radio_interface_map != NULL);) {
        if (!strstr(tmp_radio_interface_map->radio_name, "radio")) {
            ...
            snprintf(tmp_radio_interface_map->radio_name,
                sizeof(tmp_radio_interface_map->radio_name), "radio%d",
                tmp_radio_interface_map->radio_index + 1);
            index++;
            break;
        }
        tmp_radio_interface_map++;
...
void rearrange_interfaces_map()
{
    ...
    tmp_interface_index_map = (wifi_interface_name_idex_map_t *)malloc(
        interface_count * sizeof(wifi_interface_name_idex_map_t));
    if (tmp_interface_index_map != NULL) {
        memset(tmp_interface_index_map, 0,
            interface_count * sizeof(wifi_interface_name_idex_map_t));
    }

    tmp_radio_interface_map = (radio_interface_mapping_t *)malloc(
        radio_interface_count * sizeof(radio_interface_mapping_t));
    if (tmp_radio_interface_map != NULL) {
        memset(tmp_radio_interface_map, 0,
            radio_interface_count * sizeof(radio_interface_mapping_t));
    }

    memcpy(tmp_interface_index_map, interface_index_map,
        interface_count * sizeof(wifi_interface_name_idex_map_t));
    memcpy(tmp_radio_interface_map, l_radio_interface_map,
        radio_interface_count * sizeof(radio_interface_mapping_t));
